...
| <a name="input_settings_backup_configuration_start_time"></a> [settings\_backup\_configuration\_start\_time](#input\_settings\_backup\_configuration\_start\_time) | (Optional) HH:MM format time indicating when backup configuration starts. | `string` | `"03:00"` | no |
