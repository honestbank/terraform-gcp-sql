...
| <a name="input_settings_database_flags"></a> [settings\_database\_flags](#input\_settings\_database\_flags) | List of Cloud SQL flags that are applied to the database server. See [more details](https://cloud.google.com/sql/docs/mysql/flags) | `map` | `{}` | no |
